...
public class RoundedUtils {
    ...
    final static FontRenderer fr = mc.fr;
    ...
    public static void drawSelectRoundedOutline(float x, float y, float x1, float y1, float radius1,float radius2,float radius3,float radius4,float lineWidth, int color) {
      ...
      public static void drawRoundedImageRect(float x, float y, float x1, float y1, float radius) {
          ...
          int i;
          for (i = 0; i <= 90; i += 3)
        	  worldrenderer.pos(x + radius + Math.sin(i * Math.PI / 180.0D) * radius * -1.0D, y + radius + Math.cos(i * Math.PI / 180.0D) * radius * -1.0D,0)
        	  .drawQuads(x + radius + Math.sin(i * Math.PI / 180.0D) * radius * -1.0D, y + radius + Math.cos(i * Math.PI / 180.0D) * radius * -1.0D)
        	  .endVertex(); 
          for (i = 90; i <= 180; i += 3)
        	  worldrenderer.pos(x + radius + Math.sin(i * Math.PI / 180.0D) * radius * -1.0D, y1 - radius + Math.cos(i * Math.PI / 180.0D) * radius * -1.0D,0)
        	  .drawQuads(x + radius + Math.sin(i * Math.PI / 180.0D) * radius * -1.0D, y1 - radius + Math.cos(i * Math.PI / 180.0D) * radius * -1.0D)
        	  .endVertex(); 
          for (i = 0; i <= 90; i += 3)
        	  worldrenderer.pos(x1 - radius + Math.sin(i * Math.PI / 180.0D) * radius, y1 - radius + Math.cos(i * Math.PI / 180.0D) * radius,0)
        	  .drawQuads(x1 - radius + Math.sin(i * Math.PI / 180.0D) * radius, y1 - radius + Math.cos(i * Math.PI / 180.0D) * radius)
        	  .endVertex(); 
          for (i = 90; i <= 180; i += 3)
        	  worldrenderer.pos(x1 - radius + Math.sin(i * Math.PI / 180.0D) * radius, y + radius + Math.cos(i * Math.PI / 180.0D) * radius,0)
        	  .drawQuads(x1 - radius + Math.sin(i * Math.PI / 180.0D) * radius, y + radius + Math.cos(i * Math.PI / 180.0D) * radius)
        	  .endVertex(); 
          tessellator.draw();
          glEnable(3553);
          glDisable(3042);
